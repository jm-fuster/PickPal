...
- [ ] **Enganchar los 87 textos que quedan de la ola 2**: con los 13 pasos ya en píxel entero, pueden tomar su estilo sin sacar a su contenedor de la rejilla — 51 son etiquetas de Button, que con `Label 2` a 20 px no mueven el botón de sus 36. Falta hacerlo grupo a grupo con captura antes/después, empezando por Button (51) y Date Picker Dialog (12). Ver «Estilos de texto».
