...
- [ ] **Arreglar los 13 pasos de la escala tipográfica que dan interlineado fraccionario**: `Display 1` (79,2), `Display 3` (52,8), `H2` (40,8), `H3` (36,4), `H4` (31,2), `H6` (25,2), `Label 1` (19,2), `Label 2` (16,8), `Label 3` (14,4), `Body 4` (19,6), `Body 5` (16,8), `Caption 1` (15,6) y `Caption 2` (13,2). Mientras sigan así, los 87 textos que quedan de la ola 2 no se pueden enganchar sin sacar su contenedor de la rejilla de 4px — 51 son etiquetas de Button, cuya altura de 36 (= `sizing/interactive/md`) pasaría a 32,8. La referencia está en los propios especímenes: 14px con 20 de línea, 16 con 24. Arreglar el estilo corrige a todos sus consumidores de golpe; repuntar los nodos deja el defecto dentro del estilo. Ver «Estilos de texto».
