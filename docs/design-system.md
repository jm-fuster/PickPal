...
**Lo aplazado: agrupar los 30 componentes en páginas por categoría.** FlySplit resuelve 47 sets en seis páginas (Actions, Inputs, Navigation, Content, Cards, Feedback), cada una con un frame de inventario (componente · variantes · qué es) y las notas transversales de la categoría; el árbol lateral pasa de 55 entradas a 30. Es el cambio más grande y toca lo ya escrito para Community («28 component sets on 30 documented pages»), las cifras de Start here, el índice de 37 enlaces y la convención de «una página, una anatomía» de § «Figma — anatomía de una página de componente». Decidir antes de publicar, no después.
...
**Cifras tras la pasada**: 55 páginas, 349 variables, 25 estilos de texto, 4 de efecto, 103 componentes con descripción y con enlace de documentación, 34 pares de callouts nuevos, Start here con 10 bloques.
